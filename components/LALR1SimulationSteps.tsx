...
interface LALR1SimulationStepsProps {
  simulation: LALR1SimulationResult;
}

export function LALR1SimulationSteps({
  simulation
}: LALR1SimulationStepsProps) {
  return (
      ...
      <div className="mb-4 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-400">
            Ejecución bottom-up usando ACTION/GOTO sobre estados LR(1)
            fusionados por núcleo LR(0).
          </p>
        </div>
