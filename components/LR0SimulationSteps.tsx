...
interface LR0SimulationStepsProps {
  simulation: LR0SimulationResult;
}

export function LR0SimulationSteps({
  simulation
}: LR0SimulationStepsProps) {
  return (
      ...
      <div className="mb-4 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-400">
            Ejecución bottom-up usando pila de estados, pila de símbolos y tabla
            ACTION/GOTO LR(0).
          </p>
        </div>
