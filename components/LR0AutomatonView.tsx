...
interface LR0AutomatonViewProps {
  automaton: LR0Automaton;
}

export function LR0AutomatonView({ automaton }: LR0AutomatonViewProps) {
  return (
    <section className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4 shadow-xl">
      <div className="mb-4">
        ...
        <p className="text-sm text-slate-400">
          Colección canónica de ítems LR(0), estados y transiciones.
        </p>
      </div>
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        {automaton.states.map((state) => {
          const items = formatLR0State(state, automaton.productions);
